                ...
                <div class="header-content">
                    <div class="header-media-group">
                        <button class="header-user" @click="menu">
                            <img src="@/assets/images/menu.png" alt="user" /></button><router-link :to="{name: 'index.page'}"
                          ><img
                    ...
                    <router-link :to="{name: 'index.page'}" class="header-logo"><img src="@/assets/images/logo.png" alt="logo" />
                    </router-link>
